...
# from metrics import *
from network import U_Net,R2U_Net,AttU_Net,R2AttU_Net,PLUNet,NestedUNet,PUNet,LUNet,PLUNet32,PLUNet512
...
from model.SwinNet import SwinNet
...
class Solver(object):
	...
	def build_model(self):
		...
		elif self.model_type =='PLUNet':
			self.unet = PLUNet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='NestedUNet':
			self.unet = NestedUNet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='PUNet':
			self.unet = PUNet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='LUNet':
			self.unet = LUNet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='DenseUnet':
			self.unet = DenseUnet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='UNet3Plus':
			self.unet = UNet3Plus(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='kiunet':
			self.unet = kiunet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='DoubleUNet':
			self.unet = DoubleUNet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='MultiResUnet':
			self.unet = MultiResUnet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='DenseNet':
			self.unet = DenseNet(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='PLUNet512':
			self.unet = PLUNet512(img_ch=self.img_ch,output_ch=1)
		elif self.model_type =='SwinNet':
			self.unet = SwinNet(img_ch=self.img_ch,output_ch=1)
