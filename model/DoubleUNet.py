...
class LS_block(nn.Module):
    def __init__(self,ch_in,ch_out,ch_ou):
...
class DoubleUNet(nn.Module):
    ...
    def __init__(self,img_ch=3,output_ch=1):
        ...
        self.Vgg1 = LS_block(1024,256,256)
        self.Vgg2 = LS_block(512,128,128)
        self.Vgg3 = LS_block(256,64,64)
        self.Vgg4 = LS_block(128,32,32)
        ...
        self.Vgg5 = LS_block(1024,256,256)
        self.Vgg6 = LS_block(640,128,128)
        self.Vgg7 = LS_block(320,64,64)
        self.Vgg8 = LS_block(160,32,32)
