...
class MultiResUnet(torch.nn.Module):
    def __init__(self,img_ch=3,output_ch=1, nf=32, use_dropout=False):
    # def __init__(self, in_channels, out_channels, nf=32, use_dropout=False):
        super(MultiResUnet, self).__init__()
        self.mres_block1 = MultiResBlock(img_ch, u=nf)
        ...
        self.conv10 = conv2d_bn(self.mres_block9.out_channel, output_ch, 1, padding='same', activation='tanh')
